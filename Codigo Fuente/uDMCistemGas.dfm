object DMCistemGas: TDMCistemGas
  ...
  object Channel: TROWinInetHTTPChannel
    ...
    DispatchOptions = []
    ServerLocators = <>
    TargetURL = 'http://localhost:9001/BIN'
  ...
  object RemoteServiceProxy: TRORemoteService
  ...
  object RemoteDataAdapterProxy: TDARemoteDataAdapter
    GetSchemaCall.RemoteService = RemoteServiceProxy
    GetDataCall.RemoteService = RemoteServiceProxy
    GetDataCall.MethodName = 'GetData'
    GetDataCall.Params = <
      item
        Name = 'Result'
    ...
    GetDataCall.OutgoingTableRequestInfosParameter = 'aTableRequestInfoArray'
    GetDataCall.IncomingDataParameter = 'Result'
    UpdateDataCall.RemoteService = RemoteServiceProxy
    GetScriptsCall.RemoteService = RemoteServiceProxy
    RemoteService = RemoteServiceProxy
    DataStreamer = DataStreamer
    Left = 192
    Top = 168
  end
