...
FUNCTION  Utf8ToAnsi  (Source : STRING; UnknownChar : CHAR = '¿') : STRING;  // Convert UTF-8 to Win-1252
...
FUNCTION  Utf8ToAnsi (Source : STRING; UnknownChar : CHAR = '¿') : STRING;
