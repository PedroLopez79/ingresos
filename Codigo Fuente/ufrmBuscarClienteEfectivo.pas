unit ufrmBuscarClienteEfectivo;
...
type
  TfrmBuscarClienteEfectivo = class(TfrmBuscar)
...
var
  frmBuscarClienteEfectivo: TfrmBuscarClienteEfectivo;
...
procedure TfrmBuscarClienteEfectivo.cdsBuscarFilterRecord(DataTable: TDADataTable;
  var Accept: Boolean);
begin
  inherited;
...
procedure TfrmBuscarClienteEfectivo.cxGridDBTableView1DblClick(Sender: TObject);
begin
...
procedure TfrmBuscarClienteEfectivo.cxGridDBTableView1KeyDown(Sender: TObject;
