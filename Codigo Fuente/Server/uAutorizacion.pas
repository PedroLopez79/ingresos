...
begin
  ...
  case Cual of    //
    ...
    ERR_GOB_AUTFALLIDA: Result:= 'Autentificación fallida Comunicarse con el administrador del sistema';
    ERR_GOB_INFNODISP: Result:= 'Comunicarse con la Oficialía Mayor de Gobierno';
