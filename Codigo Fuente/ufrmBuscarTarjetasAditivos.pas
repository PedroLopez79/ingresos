...
function Abrir_BuscarTarjetaAditivos(ClienteID: Integer):Integer;
...
procedure TfrmBuscarTarjetasAdivitos.cxButton1Click(Sender: TObject);
begin
...
procedure TfrmBuscarTarjetasAdivitos.cxButton2Click(Sender: TObject);
begin
  close;
end;

procedure TfrmBuscarTarjetasAdivitos.cxGridDBTableView1DblClick(
  Sender: TObject);
begin
  Clave:= cdsBuscar.FieldByName('VehiculoID').AsInteger;
  Nombre:= cdsBuscar.FieldByName('Nombre').AsString;
