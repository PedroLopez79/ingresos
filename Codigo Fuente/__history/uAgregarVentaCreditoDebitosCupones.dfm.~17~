object Fo_AgregarVentaCreditoDebitosCupones: TFo_AgregarVentaCreditoDebitosCupones
  Left = 303
  Top = 281
  BorderStyle = bsDialog
  Caption = 'Agregar Venta Credito, Debitos y Cupones'
  ClientHeight = 236
  ClientWidth = 528
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object btnBuscaProducto: TcxButton
      Left = 122
      Top = 21
      Width = 25
      Height = 21
    ...
    object edtReferenciaCliente: TcxCurrencyEdit
      Left = 339
      Top = 139
      Hint = ''
      Enabled = False
