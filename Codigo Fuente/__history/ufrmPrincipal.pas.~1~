...
const
  TotalModulos = 51;
  Modulos: Array[1..TotalModulos] of string = ('Blank',
                                               'Reportes',
                                               ...
                                               'Autorizaciones',
                                               'FacturaXCliente',
                                               'Reporte SAT Creditos',
                                               'ReenviaCorreo SAT Creditos',
                                               'Reporte SAT Efectivos',
                                               'ReenviaCorreo SAT Efectivos',
                                               'Consumo Manual',
                                               'Generar Dispotivo',
                                               'Ingresos',
                                               'TipoCambio',
